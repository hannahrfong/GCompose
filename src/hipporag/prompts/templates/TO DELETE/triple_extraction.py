...
shots = shots = [
    ...
    # Shot 12
    {
        "passage": twelve_shot_ner_paragraph,
        "named_entity_json": twelve_shot_ner_output,
        "triples": twelve_shot_triples_output
    },
    # Shot 13
    {
        "passage": thirteen_shot_ner_paragraph,
        "named_entity_json": thirteen_shot_ner_output,
        "triples": thirteen_shot_triples_output
    }
]
